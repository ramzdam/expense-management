        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{!! route('user.userupdate', ['id' => $user_pid]) !!}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="work" type="text" class="form-control @error('work') is-invalid @enderror" name="work" value="{{ $user->work }}" required autocomplete="work" autofocus>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary" id="user-update-user">
                                    {{ __('Update') }}
                                </button>
                            </div>
                        </div>
